...
namespace DialogBuilder.Scripts.Nodes.Utility
{
  public class CustomPort : Port
  {
    ...
    {
      CustomPort.NewDefaultEdgeConnectorListener listener = new CustomPort.NewDefaultEdgeConnectorListener();
      CustomPort ele = new CustomPort(orientation, direction, capacity, type)
      {
    ...
    protected CustomPort(
      Orientation portOrientation,
      Direction portDirection,
      Port.Capacity portCapacity,
      System.Type type) : base(portOrientation,
      portDirection,
      portCapacity,
      type)
    { }
    private class NewDefaultEdgeConnectorListener : IEdgeConnectorListener
    {
      private GraphViewChange m_GraphViewChange;
      private List<Edge> m_EdgesToCreate;
      private List<GraphElement> m_EdgesToDelete;

      public NewDefaultEdgeConnectorListener()
      {
